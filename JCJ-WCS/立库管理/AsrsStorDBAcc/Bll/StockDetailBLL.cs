...
namespace AsrsStorDBAcc.BLL
{
    ...
    {
        private readonly AsrsStorDBAcc.DAL.StockDetailDAL dal = new AsrsStorDBAcc.DAL.StockDetailDAL();
        ...
        /// 获得数据列表
        /// </summary>
        public List<AsrsStorDBAcc.Model.StockDetailModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<AsrsStorDBAcc.Model.StockDetailModel> DataTableToList(DataTable dt)
        {
            List<AsrsStorDBAcc.Model.StockDetailModel> modelList = new List<AsrsStorDBAcc.Model.StockDetailModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                AsrsStorDBAcc.Model.StockDetailModel model;
